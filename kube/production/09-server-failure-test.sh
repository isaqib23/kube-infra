...
# Run this script on k8s-cp1 to test HA failover and data persistence
...
TEST_SERVER="k8s-cp2"  # This is the server we'll shutdown
TEST_SERVER_IP="10.255.254.11"
...
3. PODS ON HEALTHY NODES:
   - Pods on k8s-cp1, k8s-cp3, k8s-cp4 continue running normally
