...
# Run this script on BOTH Dell R740 servers
...
show_completion_info() {
    ...
    echo "3. Run 03-ha-cluster-init.sh on k8s-stg1 to initialize cluster"
    echo
...
case "${1:-}" in
    --help|-h)
        ...
        echo "Run this script on BOTH Dell R740 servers after server preparation."
        exit 0
        ;;
    *)
        main "$@"
